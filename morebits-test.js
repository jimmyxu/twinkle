...
Twinkle.morebitsTestInit = function () {
	if ( mw.config.get("wgAction") === "view" && mw.config.get("skin") === "vector" && mw.config.get("wgNamespaceNumber") >= 0 ) {
		Twinkle.addPortlet( ("javascript:Twinkle.morebitsTest.launchDialog(Twinkle.morebitsTest.$runTests)"), "测试", "tw-test", "测试morebits.js", "");
	}
}
...
if ( typeof Twinkle === 'undefined' ) {
	throw new Error( '在还未载入Twinkle时试图加载“morebits-test”模块。' );
}
